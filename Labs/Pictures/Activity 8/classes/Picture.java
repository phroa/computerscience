...
public class Picture extends SimplePicture 
{
  ...
  public void mirrorArms()
  {
    ...
    for (int row = 164; row < 191; row++)
    {
      ...
      for (int col = 100; col < mirrorPoint; col++)
      {
        ...
        leftPixel = pixels[row][col];      
        rightPixel = pixels[pixels.length - 1 - row]                       
                         [col];
        rightPixel.setColor(leftPixel.getColor());
      }
    }
  ...
  public void myCollage()
  {
    ...
    Picture flower3 = new Picture("640x480.jpg");
    this.copy(flower1,0,0);
    this.copy(flower2,100,0);
    this.copy(flower1,200,0);
    Picture flowerNoBlue = new Picture("snowman.jpg");
    flowerNoBlue.zeroBlue();
    flowerNoBlue.mirrorVertical();
    flower3.mirrorArms();
    this.copy(flowerNoBlue,300,0);
    this.copy(flower1,400,0);
    this.copy(flower2,500,0);
    this.copy(flower3,440,0, 300, 420);
    this.mirrorVertical();
    this.write("collage.jpg");
  }
