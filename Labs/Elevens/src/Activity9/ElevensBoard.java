...
public class ElevensBoard extends Board {
	...
	private boolean containsPairSum11(List<Integer> selectedCards) {
        ...
        for (Integer card : selectedCards) {
            values.add(cardAt(card).pointValue());
        }

        return (values.contains(1) && values.contains(10)) ||
                (values.contains(2) && values.contains(9)) ||
                (values.contains(3) && values.contains(8)) ||
                (values.contains(4) && values.contains(7)) ||
